# langgraph example — reserved for a future release
...
In the meantime, you can wire TraceForge into any langgraph app manually:

```python
import traceforge

tracer = traceforge.Tracer("langgraph-example")
