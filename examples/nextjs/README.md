# nextjs example — reserved for a future release
...
In the meantime, you can wire TraceForge into any nextjs app manually:

```python
import traceforge

tracer = traceforge.Tracer("nextjs-example")
