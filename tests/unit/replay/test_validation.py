...
def test_replay_validator_missing_relationship_nodes():
    n1 = NodeRecord(node_id="n1", graph_id="g1", type="function", name="main", started_at=datetime.now(timezone.utc), status="completed")
    rel = RelationshipRecord(relationship_id="r1", graph_id="g1", source_node_id="n1", target_node_id="missing_n2", type="parent_child")
