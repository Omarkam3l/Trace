...
def test_visualization_engine_transformations():
    ...
    n1 = NodeRecord(node_id="n1", graph_id="g1", type="function", name="main", started_at=now, duration_ms=10.0, status="completed", child_ids=["n2"])
    n2 = NodeRecord(node_id="n2", graph_id="g1", type="function", name="helper", started_at=now, duration_ms=5.0, status="completed", parent_id="n1")
